...
[`@aws-sdk/client-chime-sdk-voice`](https://www.npmjs.com/package/@aws-sdk/client-chime-sdk-voice/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O2PlHXM3trWd4z0QydPqPixZptkct+1sBoabURW2eVTSS6em9HeGS/WQRD77PVlK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-chime-sdk-voice": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.993.0/index.min.mjs": "sha384-O2PlHXM3trWd4z0QydPqPixZptkct+1sBoabURW2eVTSS6em9HeGS/WQRD77PVlK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-chime-sdk-voice/blob/refs/tags/3.993.0/LICENSE
```
