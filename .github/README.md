...
[`@aws-sdk/client-chime-sdk-voice`](https://www.npmjs.com/package/@aws-sdk/client-chime-sdk-voice/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9naAZ1q9OTlZjbOqR0bSvPam2xbbBMliarmBSRiKIKDpIE67If4H7tVMrzs9i+P/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-chime-sdk-voice": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-voice@3.245.0/index.min.mjs": "sha384-9naAZ1q9OTlZjbOqR0bSvPam2xbbBMliarmBSRiKIKDpIE67If4H7tVMrzs9i+P/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-chime-sdk-voice/blob/refs/tags/3.245.0/LICENSE
```
